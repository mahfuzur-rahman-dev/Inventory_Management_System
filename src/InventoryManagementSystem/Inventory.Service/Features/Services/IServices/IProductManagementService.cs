...
namespace Inventory.Service.Features.Services.IServices
{
    public interface IProductManagementService
    {
        ...
        Task CreateProductAsync(string name, string description,decimal unitPrice, int quantity, Guid categoryId,Guid userId);
        Task RemoveProductAsync(Product category);
        Task UpdateProductAsync(Guid id, string name, string description, decimal unitPrice, int quantity, Guid categoryId);
